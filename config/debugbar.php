...
return [
    ...
    // Atado a APP_ENV=local explícitamente, no solo a APP_DEBUG: Debugbar expone
    // bindings de queries y datos de sesión completos, y este es un SaaS
    // multi-tenant con datos reales de owners — no debe poder encenderse por
    // accidente en un entorno con APP_DEBUG=true que no sea local (ej. staging).
