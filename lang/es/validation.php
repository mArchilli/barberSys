...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute ingresado apareció en una filtración de datos conocida. Elegí un :attribute diferente.',
    ],
    ...
    */
    ...
    'custom' => [
        'salary_amount' => [
            'required_if' => 'El monto fijo es obligatorio cuando el tipo de sueldo es fijo.',
        ],
        'commission_pct' => [
            'required_if' => 'El porcentaje de comisión es obligatorio cuando el tipo de sueldo es por comisión.',
        ],
        'cliente_nombre' => [
            'required_without' => 'Elegí un cliente existente o escribí el nombre de uno nuevo.',
        ],
    ],
