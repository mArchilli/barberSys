                ...
                <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                    ...
                    {mediosFiltrados.length === 0 ? (
                        <div className="rounded-brand-lg border border-brand-border bg-brand-surface p-8 text-center text-brand-text-secondary shadow-brand-card">
                            {busqueda ? (
                                'No se encontraron medios de pago con ese criterio.'
                            ) : (
                                <>
                            ...
                            {mediosFiltrados.map((m) => (
                                <div
                                    ...
                                    className={`rounded-brand-lg border p-5 shadow-brand-card transition hover:shadow-brand-card-hover ${
                                        m.active ? 'border-brand-border bg-brand-surface' : 'border-brand-border bg-brand-surface-alt'
                                    }`}
                                >
                                    <div className="flex items-start justify-between gap-2">
                                        <h3 className="truncate font-semibold text-brand-text">{m.name}</h3>
                                        {m.active ? (
