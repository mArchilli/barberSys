                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <p className="mt-2 max-w-2xl text-sm text-brand-text-secondary">
                            Actualiza sus datos personales, ajusta el tipo de liquidacion y define si la cuenta sigue activa.
                        </p>
                    </div>
                            ...
                            <div className="flex min-w-0 items-start gap-4">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="mt-2 text-sm text-brand-text-secondary">
                                        Mantene actualizada su informacion para que el panel refleje siempre el estado real del equipo.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="space-y-6">
                                            ...
                                            <div className="mt-4 grid gap-3">
                                                ...
                                                >
                                                    ...
                                                    <span className="block">
                                                        ...
                                                        <span className="mt-1 block text-xs text-brand-text-secondary">
                                                            Conserva un monto mensual estable para este perfil.
                                                        </span>
                                                    </span>
                                                </label>
                                                ...
                                                >
                                                    ...
                                                    <span className="block">
                                                        ...
                                                        <span className="mt-1 block text-xs text-brand-text-secondary">
                                                            Ajusta el porcentaje que recibe sobre lo trabajado.
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                    ...
                                    <div className="rounded-[24px] bg-brand-surface-alt px-5 py-5">
                                        <div className="flex items-start justify-between gap-4">
                                            ...
                                            <label className="inline-flex cursor-pointer items-center gap-3 rounded-full border border-brand-border bg-brand-surface px-4 py-2.5">
                                                <input
                                                    id="active"
                                                    type="checkbox"
                                                    checked={data.active}
