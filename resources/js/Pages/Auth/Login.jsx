    ...
    return (
        <>
            <GuestLayout organicBackground maxWidth="sm:max-w-[30rem]">
                ...
                <div className="relative isolate -mb-10 pb-10 pt-5 before:absolute before:-bottom-[100vh] before:left-1/2 before:top-0 before:-z-10 before:w-screen before:-translate-x-1/2 before:bg-brand-primary sm:-mb-14 sm:pb-14 lg:mb-0 lg:pb-0 lg:pt-0 lg:before:hidden">
                    {status && (
